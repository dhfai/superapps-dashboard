...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 rounded-t-xl flex bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
